                  ...
                  <div className="space-y-1 mb-2">
                      ...
                      return (
                        <div key={email} className="flex items-center justify-between bg-horizon-card/50 rounded px-2 py-1">
                            ...
                            size="sm"
                            variant="ghost"
                            onClick={() => handleRemoveAssignee(email)} className="bg-slate-900 text-red-400 p-0 text-sm font-medium rounded-md inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-horizon-primary/50 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-horizon-primary/10 hover:text-horizon-primary active:bg-horizon-primary/20 h-9 h-5 w-5"
