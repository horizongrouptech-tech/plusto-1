...
function findHeaderRow(rows, maxRowsToCheck = 15) {
  const knownHeaders = [
    'שם מוצר', 'שם פריט', 'שם המוצר', 'תיאור', 'product_name', 'name',
    'ברקוד', 'מק"ט', 'מקט', 'barcode', 'sku',
    'מחיר', 'מחיר עלות', 'מחיר מכירה', 'עלות', 'price', 'cost',
    'קטגוריה', 'category', 'ספק', 'supplier'
  ];
  ...
  try {
    ...
    return new Response(JSON.stringify({
      ...
      data: {
        ...
        raw_data: rawData.slice(0, 100), // מקסימום 100 שורות לתצוגה מקדימה
