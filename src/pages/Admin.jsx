                          ...
                          {isAdmin && (
                            <div className="mt-6 p-4 border border-horizon rounded-lg bg-horizon-card/50">
                              <h4 className="text-horizon-text font-semibold mb-3 flex items-center gap-2">
                                ...
                                כלי מיגרציה - מקור ספק ללקוח
                              </h4>
                              <p className="text-horizon-accent text-sm mb-4">
                                כלים אלו מעדכנים את השדה "הוקם עבור לקוח" (created_for_customer_email) עבור ספקים קיימים. הרץ קודם את הבדיקה ואז את המיגרציה.
                              </p>
                                ...
                                <Button
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      report += `כבר מעודכנים (יש created_for_customer_email): ${alreadySet.length}\n`;
                                      report += `צריכים מיגרציה: ${needsMigration.length}\n\n`;
                                      report += `--- ניתן לעדכן אוטומטית: ${okToMigrate.length} ---\n`;
                                      report += `(יוגדר created_for_customer_email = customer_emails[0])\n\n`;

                                      if (noCustomers.length > 0) {
                                        report += `--- בעייתיים - אין customer_emails: ${noCustomers.length} ---\n`;
                                ...
                                <Button
                                  ...
                                  onClick={async () => {
                                    const confirmed = window.confirm(
                                      'פעולה זו תעדכן את כל הספקים שעדיין אין להם שדה "הוקם עבור לקוח".\n' +
                                      'לכל ספק עם customer_emails, האימייל הראשון ברשימה ייקבע כלקוח המקור.\n\n' +
